# Generated by Django 4.2.10 on 2024-02-08 09:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Knygos aprašymas', max_length=1000, verbose_name='Aprašymas')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Prašome įvesti knygos žanrą', max_length=200, verbose_name='Pavadinimas')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('a', 'Administruojama'), ('s', 'Šiuo metu skaitoma'), ('p', 'Prienama'), ('r', 'Rezervuota')], default='a', help_text='Statusas', max_length=1)),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Pasirinkite žanrą', to='library.genre'),
        ),
    ]
